...
class LifeInsuranceView extends StatefulWidget {
  @override
  _LifeInsuranceViewState createState() => _LifeInsuranceViewState();
}

class _LifeInsuranceViewState extends State<LifeInsuranceView> {
  late LifeInsuranceController _controller;

  @override
  void initState() {
    super.initState();
    _controller = LifeInsuranceController();
  }
